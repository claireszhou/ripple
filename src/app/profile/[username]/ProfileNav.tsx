...
export function ProfileNav({ profile }: { profile: Profile }) {
  return (
      ...
      <div className="mx-auto flex max-w-2xl items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            ...
            className="flex shrink-0 items-center justify-center overflow-hidden rounded-full ring-1 ring-sky-200 transition hover:ring-sky-400 dark:ring-sky-700 dark:hover:ring-sky-500"
            aria-label="Profile"
          >
            {profile.avatar_url ? (
              <img
